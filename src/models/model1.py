...
class Model1(CommonMixin, CreatedModifiedMixin, Base):
    ...
    m2m_links: Mapped[list["Model1ToModel2"]] = relationship(
        back_populates="model1", lazy="joined"
    )
...
class Model1ToModel2(CreatedModifiedMixin, Base):
    ...
    model1: Mapped["Model1"] = relationship(back_populates="m2m_links", lazy="joined")
    model2: Mapped["Model2"] = relationship(back_populates="m2m_links", lazy="joined")
